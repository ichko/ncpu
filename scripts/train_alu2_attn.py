...
Usage:
    uv run python scripts/train_alu2_attn.py
    uv run python scripts/train_alu2_attn.py --seed 1 --steps 300000
    uv run python scripts/train_alu2_attn.py --resume last
"""
