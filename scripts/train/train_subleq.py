...
Usage:
    uv run python scripts/train/train_subleq.py
    uv run python scripts/train/train_subleq.py --steps 40000 --seed 1
    uv run python scripts/train/train_subleq.py --resume last
"""
