...
Usage:
    uv run python scripts/train/train_alu2.py
    uv run python scripts/train/train_alu2.py --seed 1 --steps 300000
    uv run python scripts/train/train_alu2.py --resume last
"""
