...
(see scripts/train_alu2.py), with one swap: NeuralCA -> TemporalSobelNCA.
...
Usage:
    uv run python scripts/train_alu2_temporal.py
    uv run python scripts/train_alu2_temporal.py --seed 1 --history 4
    uv run python scripts/train_alu2_temporal.py --resume last
"""
