...
Usage:
    uv run python scripts/train_adder.py --bits 4 --seed 0
    uv run python scripts/train_adder.py --bits 8 --seed 0 --layout cols1
    uv run python scripts/train_adder.py --bits 8 --seed 0 --layout cols2
