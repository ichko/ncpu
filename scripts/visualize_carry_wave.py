...
Usage:
    uv run python scripts/visualize_carry_wave.py
    uv run python scripts/visualize_carry_wave.py --run_dir runs/E3_adder8_cols2_s0_20260316_033201
    uv run python scripts/visualize_carry_wave.py --steps 128 --out carry_wave.svg
"""
