...
Usage:
    uv run python scripts/train_alu2_gated.py --history 1                 # control
    uv run python scripts/train_alu2_gated.py --history 3 --hard --wcb 4  # max
    uv run python scripts/train_alu2_gated.py --resume last
"""
